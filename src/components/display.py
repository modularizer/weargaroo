...
from components.colors import ColorPalette, get_color
...
class Display(ST7789Display):
    ...
    def text(self, text="Hello World", scale=2, x=50, y=120, color=0xFFFFFF, show=None, group=None, **kwargs):
        text_group = DisplayText(text, scale=scale, x=x, y=y, color=color, **kwargs)
    ...
    def type(self, text="Hello World", scale=2, x=50, y=120, color=0xFFFFFF, show=None, group=None,
        ...
        text_group = DisplayText("", scale=scale, x=x, y=y, color=color, type=type, letter_delay=letter_delay,
...
class DisplayText(displayio.Group):
    def __init__(self, text="", scale=1, x=0, y=0, line_spacing=20, font=FONT, color=0xFFFFFF,
                 background_color=None, tab_replacement=(2, " "), **kwargs):
        super().__init__(scale=scale, x=x, y=y)
        self._color = get_color(color)
        self.background_color = get_color(background_color)
        kwargs.update({"tab_replacement": tab_replacement,
                       "font": font,
    ...
    def write(self, text, color=None, background_color="default", **kwargs):
        ...
        self.label = label.Label(text=text, color=color, background_color=background_color, **self.kwargs)
